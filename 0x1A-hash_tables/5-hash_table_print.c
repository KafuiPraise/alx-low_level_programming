...
/**
 * hash_table_print_sep - outputs a separator between elements in a hash table
 *
 */
...
/**
 * hash_chain_print - outputs the elements in a singly-linked list
...
/**
 * hash_table_print - outputs the elements in a hash table
